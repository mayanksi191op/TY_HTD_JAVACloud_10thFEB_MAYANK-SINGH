		...
		<table border="1" class="table table-striped table-bordered">
			...
			<a:forEach items="${list}" var="employee">
				...
				<tr>
					...
					<td><a
						href="${pageContext.request.contextPath}/EmployeeController?action=EDIT&employee_id=${employee.employee_id}">Edit</a>
					</td>
					<td><a
						href="${pageContext.request.contextPath}/EmployeeController?action=DELETE&employee_id=${employee.employee_id}">Delete</a>
					</td>
				</tr>
