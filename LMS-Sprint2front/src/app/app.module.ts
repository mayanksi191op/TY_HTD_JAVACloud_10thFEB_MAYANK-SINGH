...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      {path:'viewclient', component: ViewclientComponent, data: {roles: ['ROLE_ADMIN']}, canActivate: [AuthGuard]},
      ...
      {path:'viewdetails', component: ViewdetailsComponent, data: {roles: ['ROLE_CUSTOMER']}, canActivate: [AuthGuard]},
      {path:'changepassword', component: ChangepasswordComponent, data: {roles: ['ROLE_CUSTOMER']}, canActivate: [AuthGuard]},
      ...
      {path:'editprofile', component: EditprofileComponent, data: {roles: ['ROLE_CUSTOMER']}, canActivate: [AuthGuard]}
    ]),
