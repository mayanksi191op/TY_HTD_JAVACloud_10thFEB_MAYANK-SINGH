...
public class LoginDaoTest {
	...
	void registerTest1() {
		Repository.userTable();
		Boolean isBoolean = implementation.register("businessman", "5/10/1996", "male", "Mayank@123", "mayank123@gmail.com", "Qwerty@123", "Mayank", "Singh", 7611093264L, 50000.0);
		assertEquals(isBoolean, true);
	}
	...
	void registerTest2() {
		Repository.userTable();
		Boolean isBoolean = implementation.register("serviceman", "5/10/1996", "male", "anand@123", "anand123@gmail.com", "Qwerty@123", "anand", "Singh", 7611093264L, 50000.0);
		assertEquals(isBoolean, true);
	}
}
